...
/***/ function(module, exports, __webpack_require__) {
	...
	var getArticle = __webpack_require__(93);
	...
	module.exports = {
	  ...
	  methods: {
	    getArticleFun: function getArticleFun(title) {
	      var _this = this;
	
	      if (this.article.title == title) {
	        return;
	      }
	      getArticle(this.$http, title).then(function (re) {
	        if (re.err) {
	          alert(re.str);return;
	        }
	        ...
	        if (title == re.data.title) {
	          ...
	          _this.article.body = re.data.body;
	        }
	      }).catch(function (err) {
	        alert(err);
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (http, title) {
	  return new _promise2.default(function (resolve, reject) {
	    http.get("/getArticle?title=" + title).then(function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#article-box .a-body {\n  line-height: 1.4;\n}\n#article-box pre {\n  background: #eee;\n  padding: 10px;\n  border-radius: 5px;\n}\n", ""]);
