...
/***/ function(module, exports, __webpack_require__) {
	...
	var getArticle = __webpack_require__(81);
	...
	module.exports = {
	  ...
	  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
	    next(function (vm) {
	      if (to.params.title != vm.articleList.title) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	module.exports = function (http, name) {
	  return new _promise2.default(function (resolve, reject) {
	    http.get("/getArticle?name=" + name).then(function (response) {
